...
parser.add_argument('--file_path', type=str, default='', help='input file path')
parser.add_argument('--label_path', type=str, default='', help='file label path')
...
if __name__ == '__main__':
    ...
    data, label = get_file_path(args.file_path, args.label_path)
